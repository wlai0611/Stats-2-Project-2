...
BankAF %>% ggplot(aes(x = euribor3m, fill = Subscription)) + geom_histogram(binwidth = 1) + theme(axis.text.x = element_blank(), axis.ticks.x = element_blank()) + facet_wrap(facets = BankAF$Subscription) + xlab("euribor") + coord_flip()

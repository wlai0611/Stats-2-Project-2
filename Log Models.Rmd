...
full.log <- glm(Subscription ~ ., family = 'binomial', data = BankAF.train[,-c(5,21)])
...
custom.log <- glm(Subscription ~ emp.var.rate + euribor3m + nr.employed + pdays + month + poutcome + contact + euribor3m*nr.employed,
                  family = "binomial", data = BankAF.train[,-21])

...
full.log <- glm(Subscription ~ (.)^2, family = 'binomial', data = BankAF.train)
...
Bank.Train.x <- model.matrix(Subscription ~ ., BankAF.train[,-c(5,21)])
...
Bank.Test.x <- model.matrix(Subscription ~ ., BankAF.test[,-c(5,21)])
